...
${darkModeDiagramFixCSS({
  bgColor: '#0B1120',
  borderColor: '#1A3D5A',
  erAttrEvenFill: '#1A2848',
  erAttrOddFill: '#142040',
  mutedColor: '#1E293B',
  textColor: '#CBD5E1'
})}`;
...
export const blueprintTheme: DiagramTheme = {
  dark: {
    ...
    diagramVariables: {
      activationBkgColor: '#182545',
      activationBorderColor: '#22D3EE',
      actorBkg: '#122848',
      actorBorder: '#22D3EE',
      actorTextColor: '#CBD5E1',
      attributeBackgroundColorEven: '#1A2848',
      attributeBackgroundColorOdd: '#142040',
      /* Medium-brightness fills for dark mode — blueprint-tinted, visible on dark bg */
      cScale0: '#154570',
      cScale1: '#155268',
      cScale2: '#1E5838',
      cScale3: '#6B4C0A',
